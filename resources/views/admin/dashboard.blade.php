...
<div class="dashboard-container">
    ...
    <div class="dashboard-header">
        ...
        <p>Selamat datang di panel admin Gereja HKBP Bengkalis</p>
    </div>
    ...
    <div class="content-grid">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{ route('admin.pengajuan.index') }}" class="btn-link">
                        ...
                        <table class="data-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.pengajuan.show', $pengajuan->id) }}" class="btn-link">
                                            Detail
                                        </a>
                                    </td>
                                </tr>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{ route('admin.jemaats.index') }}" class="btn-link">
                    Lihat Semua <i class="fas fa-arrow-right"></i>
                </a>
            </div>
            <div class="card-body">
